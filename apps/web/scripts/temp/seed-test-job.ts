...
async function main() {
    ...
    const job = await prisma.job.create({
        data: {
            ...
            description: 'Fabrika elektrik panosu montaj işi - Alt görevler ve fotoğraf testi',
                ...
                create: [
                    {
                        ...
                        subSteps: {
                            create: [
                                ...
                                { title: 'Güvenlik ekipmanları hazırlığı', order: 3, isCompleted: false }
                            ]
                        }
                    },
                    {
                        ...
                        subSteps: {
                            create: [
                                { title: 'Pano kasasının yerleştirilmesi', order: 1, isCompleted: false },
                    ...
                    },
                    {
                        ...
                        subSteps: {
                            create: [
                                { title: 'Ana besleme kabloları', order: 1, isCompleted: false },
                                { title: 'Dağıtım kabloları', order: 2, isCompleted: false },
                                { title: 'Topraklama bağlantıları', order: 3, isCompleted: false },
