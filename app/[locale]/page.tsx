      ...
      <div className="text-center max-w-4xl mx-auto px-4">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <h3 className="text-lg font-semibold mb-2">{t('features.tracking.title')}</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            <div className="text-indigo-600 text-3xl mb-3">👥</div>
            <h3 className="text-lg font-semibold mb-2">{t('features.teams.title')}</h3>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            <div className="text-indigo-600 text-3xl mb-3">📊</div>
            <h3 className="text-lg font-semibold mb-2">{t('features.reporting.title')}</h3>
            <p className="text-gray-600 text-sm">
