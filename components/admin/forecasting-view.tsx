        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {forecasts.length === 0 ? (
                <Card className="col-span-full p-12 flex flex-col items-center justify-center text-muted-foreground italic">
                    ...
                    {t('admin.noData') || 'Henüz yeterli veri toplanmadı.'}
                </Card>
            ) : (
                        ...
                        <CardContent>
                            <div className="flex items-end justify-between">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-[10px] text-muted-foreground">{t('admin.avgDuration') || 'Ortalama Tamamlanma Süresi'}</p>
                                </div>
                                <div className="bg-muted px-2 py-1 rounded text-[10px] font-medium">
                                    {item.sampleSize} {t('admin.samples') || 'örnek veri'}
                                </div>
                            </div>
